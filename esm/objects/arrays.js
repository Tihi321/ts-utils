 ...
 * @return {void}
 */
export var rangeEach = function (range, callback) {
 ...
 */
export var rangeMap = function (range, callback) {
    var returnArray = [];
    for (var index = 0; index < range; index += 1) {
 ...
 */
export var rangeReduce = function (range, callback, initialValue) {
 ...
 */
export var orderedPromiseAll = function (promises, promiseCallback, resultCallback) {
