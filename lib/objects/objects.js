...
exports.swapObjectCleanedData = exports.swapObjectData = exports.cleanObject = exports.objectFilter = exports.objectMap = exports.objectLoop = exports.renameKeys = exports.pickFirstObjectItem = void 0;
...
var pickFirstObjectItem = function (object, subValue) {
    ...
    Object.entries(object).forEach(function (_a) {
        ...
        returnObj[key] = subValue
            ? (0, lodash_1.head)(values)[subValue]
            : (0, lodash_1.head)(values);
    });
    return returnObj;
};
...
var cleanObject = function (object) {
    return (0, exports.objectFilter)(object, function (value) { return Boolean(value); });
};
 ...
 * @return {object} returns udapted object
 */
var swapObjectCleanedData = function (loopObject, valuesObject) { return (0, exports.cleanObject)((0, exports.swapObjectData)(loopObject, valuesObject)); };
